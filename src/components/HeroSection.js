            ...
            <div className="w-full max-w-7xl mx-auto px-6">
                <div className="grid lg:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center lg:text-left space-y-8">
                        ...
                        >
                            Generate{' '}
                            <span className="text-gray-900 font-bold">Quality Leads</span>
                            <br />
                            <span className="hover:animate-wobble cursor-default">That Convert</span>
                        </h1>
                        <p className="text-lg sm:text-xl text-gray-600 leading-relaxed max-w-lg transition-all duration-500 hover:text-gray-700 mx-auto">
                            We help businesses generate high-quality leads and increase sales through proven marketing strategies. Get more calls, more customers, more revenue.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            <button
                                ...
                                aria-label="Get free consultation for lead generation services"
                            >
                                <svg className="w-6 h-6 animate-bounce" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                    <path d="M22 2l-10 9"></path>
                                    <path d="M22 2l-5 22l-5-10l-10-5l22-5z"></path>
                                </svg>
