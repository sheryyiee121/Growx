            ...
            <section className="py-32 bg-gray-50">
                <div className="container mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        ...
                        <div className="bg-white p-8 rounded-xl shadow-sm">
                            <h3 className="font-semibold text-gray-900 mb-4 text-lg">Is there a consultation fee?</h3>
                            <p className="text-gray-600">No, we offer free initial consultations to understand your needs and provide personalized recommendations.</p>
                        </div>
                        <div className="bg-white p-8 rounded-xl shadow-sm">
                            <h3 className="font-semibold text-gray-900 mb-4 text-lg">Do you handle the entire application process?</h3>
                            <p className="text-gray-600">Yes, we provide end-to-end support from initial consultation to final approval and ongoing assistance.</p>
                        </div>
                    </div>
                </div>
            </section>
            ...
            <section className="py-32 bg-green-500">
                <div className="container mx-auto px-6 text-center">
                    ...
                    <p className="text-xl text-green-100 mb-12 max-w-3xl mx-auto">
                        Join thousands of individuals and families who trust us to provide expert insurance and financial guidance.
                    </p>
